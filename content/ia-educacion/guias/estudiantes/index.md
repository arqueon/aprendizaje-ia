...
intentions: [practicar, comprobar, decidir]
topics: [cocreacion, pensamiento-critico, trazabilidad]
challenges: [alucinacion, autoria, dependencia]
competencies: [direccion-epistemica, verificacion, juicio-evaluativo]
evidence_status: prototipo
connections:
  - relation: requiere
    page: /ia-educacion/constelaciones/empezar-con-ia/
    reason: "Sitúa primero qué parte del trabajo debe permanecer bajo tu responsabilidad."
  - relation: aplica
    page: /ia-educacion/practicas/comprobar-afirmacion/
    reason: "Comprueba la afirmación que podría cambiar tu decisión antes de entregar."
  - relation: continua
    page: /ia-educacion/practicas/bitacora-cocreacion/
    reason: "Conserva fuentes, cambios y descartes en una bitácora breve."
