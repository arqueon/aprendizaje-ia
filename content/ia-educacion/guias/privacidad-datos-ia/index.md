---
title: "Antes de compartir: protege datos y trabajos al usar IA"
date: 2026-08-11
draft: false
...
intentions: [decidir, investigar]
topics: [privacidad, etica, investigacion]
challenges: [privacidad, confidencialidad, inequidad]
competencies: [integridad, agencia]
evidence_status: orientacion-institucional
connections:
  - relation: continua
    page: /ia-educacion/investigacion/
    reason: "Aplica la decisión de privacidad a cada etapa de una investigación."
  - relation: aplica
    page: /ia-educacion/practicas/bitacora-cocreacion/
    reason: "Registra qué información excluiste, transformaste o sustituiste y por qué."
  - relation: fundamenta
...
| Nivel | Ejemplos | Decisión prudente |
|---|---|---|
...
Esta guía conecta con la [declaración proporcional de uso](/ia-educacion/practicas/declaracion-proporcional-uso/): declarar qué apoyo dio la IA incluye, cuando hubo datos de por medio, declarar qué información excluiste o transformaste antes de pedir ese apoyo. Una línea basta —«trabajé con una versión anonimizada de las respuestas»— y convierte una precaución invisible en una práctica que otras personas pueden aprender y revisar.
