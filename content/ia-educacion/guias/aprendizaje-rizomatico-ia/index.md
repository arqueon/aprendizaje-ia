...
La IA generativa amplía la propuesta en una dirección específica: el estudiante ya no depende de la comunidad humana para activar conexiones. Puede explorar nodos lejanos al campo principal con ayuda de un modelo, contrastar interpretaciones, validar conexiones y producir mapas propios sin esperar que alguien le indique el camino. La IA, bien usada, es un acelerador rizomático.

Mal usada, en cambio, produce lo opuesto: respuestas plausibles entregadas sin recorrido, conexiones que el estudiante recibe en lugar de construir, certidumbre delegada al modelo. La diferencia entre uno y otro escenario está en el diseño pedagógico que rodea el uso.

## Los seis principios deleuzianos en versión operativa

Deleuze y Guattari (1987) formularon seis principios del rizoma que pueden traducirse a decisiones de diseño didáctico:
...
Aplicar los seis principios al diseño de una asignatura concreta exige seis decisiones operativas:
...
La asignatura se organiza en torno a una pregunta amplia, no a un programa de contenidos. La pregunta admite múltiples respuestas defendibles y obliga a explorar varios nodos para construir cualquiera de ellas. La calidad de la pregunta se mide por cuántas rutas distintas habilita.
