---
title: "Costos ecológicos de la IA y el criterio de proporcionalidad"
date: 2026-08-31
lastmod: 2026-08-31
draft: false
description: "Qué se sabe y qué no se sabe sobre la huella ambiental de la IA generativa, y cómo el criterio de proporcionalidad —ajustar la herramienta al tamaño real de la tarea— permite decidir en el aula y en la institución sin catastrofismo ni negación."
summary: "La pregunta ambiental que cabe en una decisión docente: ¿hace falta un modelo grande para esta tarea? Qué sabemos de la huella energética e hídrica de la IA, qué sigue opaco y qué decisión razonable puede tomarse hoy."
tags: ["huella ambiental", "proporcionalidad", "sostenibilidad", "decisiones tecnológicas", "alfabetización en IA"]
categories: ["guia"]
areas: ["ia", "etica"]
showHero: true
...
{{< contrato modo="lectura" quien="Docentes y academias que deciden qué herramienta pedir en una actividad y nunca han incluido el costo ambiental en esa decisión porque la pantalla no lo muestra." haras="Vas a entender qué se sabe de la huella energética e hídrica de la IA generativa, qué sigue sin medirse, y que la decisión razonable hoy es la proporcionalidad: ajustar el tamaño de la herramienta al tamaño real de la tarea." tendras="Una pregunta para añadir a cada decisión de herramienta («¿hace falta un modelo grande para esta tarea, o basta un corrector, un modelo pequeño o una revisión entre pares?») y una pregunta de cierre para el estudiantado («¿qué herramienta era proporcional a esta tarea y por qué?»)." tarda="Nueve minutos de lectura." ejemplo="Empieza con una tarea breve que pide al modelo más grande disponible reformular cinco veces un párrafo que también podría revisarse con una herramienta ligera o entre pares: la pantalla no muestra ninguna diferencia; la infraestructura movilizada, sí. La guía desarrolla la sección de costos ecológicos de las Orientaciones, enlazadas al final." >}}
...
Esta guía desarrolla la sección de costos ecológicos (§9.4) y la última pregunta de selección tecnológica (§10.2) de [las Orientaciones](/ia-educacion/orientaciones/), una propuesta académica en revisión. Las referencias siguen las fichas de esa propuesta; se indica cuando una fuente carece de identificador público en esa bibliografía.
