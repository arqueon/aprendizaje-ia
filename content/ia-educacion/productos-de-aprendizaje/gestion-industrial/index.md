...
{{< lead >}}
Una propuesta de mejora se evalúa por su capacidad de sostenerse frente a la inercia organizacional. La IAG puede leer indicadores y anticipar resistencias; la decisión de qué cambiar y cómo acompañarlo es del estudiante.
{{< /lead >}}
...
balanced scorecard). Valor formativo: pensamiento sistémico, lectura
honesta de indicadores y anticipación realista de resistencias.

**Uso formativo de la IAG:** mapear herramientas adecuadas, leer
indicadores en busca de cuellos de botella y desperdicios, anticipar
resistencias organizacionales y orientar métricas de seguimiento.
...
- **Ingeniería** — pensamiento de procesos, mejora continua basada en evidencia.
...
- Producto cercano: [Proyecto con IAG]({{< ref "/ia-educacion/productos-de-aprendizaje/proyecto" >}}) — formato proyectado para la implementación.
