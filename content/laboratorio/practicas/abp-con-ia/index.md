...
showAuthor: false
asignatura: "Multidisciplinar — adaptable a cualquier licenciatura"
---
...
Los estudiantes investigan usando fuentes académicas y la IA como asistente de síntesis. Cada fuente sugerida por la IA se verifica en bases de datos. Los hallazgos se organizan en una matriz de evidencia.

<strong>Entregable:</strong> Matriz de evidencia con columnas: fuente, resumen, verificada (sí/no), relevancia, decisión (incluir/excluir).
{{< /timelineItem >}}

{{< timelineItem icon="brain" header="Semana 6–8 — Formulación y contraste de hipótesis" subheader="Diálogo con IA como adversario" >}}
Cada equipo formula su hipótesis y la presenta a la IA pidiendo refutaciones desde distintas perspectivas. Se documentan los contraargumentos recibidos y las reformulaciones realizadas.

<strong>Entregable:</strong> Hipótesis reformulada + registro de contraargumentos de la IA + respuesta del equipo a cada uno.
{{< /timelineItem >}}

{{< timelineItem icon="arrows-rotate" header="Semana 9–12 — Desarrollo e iteración" subheader="Ciclos de retroalimentación IA + pares" >}}
Los equipos desarrollan su propuesta de solución en tres iteraciones. Cada versión pasa por retroalimentación de la IA (usando la <a href="/ia-educacion/guias/evaluacion-formativa-ia/">evaluación formativa con IA</a>) y por revisión de pares.

<strong>Entregable:</strong> Tres versiones del documento con las observaciones incorporadas y las decisiones documentadas.
{{< /timelineItem >}}
