...
const out = process.env.EVIDENCE_DIR || 'docs/design/evidence/contexto-lote-08';
const pages = [
  ['aprendizaje-activo', 'recursos/glosario/aprendizaje-activo/', ['actividad visible', 'Chi, M. T. H.']],
  ['diseno-inverso', 'recursos/glosario/diseno-inverso/', ['Etapas del diseño inverso', 'Wiggins, G.']],
  ['taxonomia-bloom', 'recursos/glosario/taxonomia-de-bloom/', ['Las categorías no obligan', 'Anderson, L. W.']],
  ['modelo-samr', 'recursos/glosario/modelo-samr/', ['Estas categorías no son una escala', 'Hamilton, E. R.']],
  ['evaluacion-autentica', 'recursos/glosario/evaluacion-autentica/', ['principios de diseño', 'no garantiza por sí sola', 'Fawns, T.']],
];
const viewports = [
