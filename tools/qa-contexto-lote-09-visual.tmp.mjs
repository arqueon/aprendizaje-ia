...
const out = process.env.EVIDENCE_DIR || 'docs/design/evidence/contexto-lote-09';
const pages = [
  ['blog-evaluacion-autentica', 'blog/ia-generativa-evaluacion-autentica/', ['Qué significa autenticidad', 'juicio evaluativo', 'decisiones situadas']],
  ['ficha-ajjawi-bearman', 'recursos/articulos/autenticidad-evaluacion-ajjawi-bearman/', ['19 de octubre de 2023', 'CC BY-NC-ND 4.0', 'no es el objeto principal']],
  ['plagio-autenticidad', 'ia-educacion/etica-y-transparencia/plagio-autenticidad-era-ia/', ['casos hipotéticos', '61.3 %', 'prueba única']],
  ['evaluacion-formativa', 'ia-educacion/guias/evaluacion-formativa-ia/', ['decisión sumativa', 'Salvaguardas antes de usar un servicio externo', 'supervisión humana']],
  ['integridad-academica', 'recursos/glosario/integridad-academica/', ['honestidad, confianza, justicia', 'equidad', 'plagio y autenticidad académica']],
];
const viewports = [
