# Conectar momentos para que el aprendizaje avance
...
La propuesta de Orientaciones es el documento de referencia que reúne estas decisiones;
...
La guía para el profesorado convierte ese criterio en una pregunta de diseño: ¿cómo utilizará
...
- Para avanzar, distingue **el cambio de la tarea y la implicación cognitiva** en [Dos
  preguntas distintas sobre una misma actividad](/formacion-docente/modelos-samr-icap/).
- Si necesitas volver a precisar **qué hará la persona con las ideas**, regresa a [Qué hace
  activa una experiencia de aprendizaje](/formacion-docente/aprendizaje-activo/).
