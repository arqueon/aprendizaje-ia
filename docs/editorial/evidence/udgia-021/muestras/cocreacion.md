# Conservar la dirección del trabajo con IA
...
![Dos sugerencias se convierten en decisiones distintas: una se transforma para conservar un matiz y la otra se comprueba antes de revisar el argumento.](../visual/comparador-cocreacion.svg)
...
aprendizaje](/formacion-docente/aprendizaje-activo/).
